...
<vxml version="1.0">
	...
	<form id="check_hangup">
		<script src="129_JS.js"/>
		<var name="nowSSP" expr=""/>	
		<object name="getcurssp" classid="method://huawei/Other/GetCurSSP">
			<param name="SSP" expr="nowSSP"/>
				<filled>
					<if cond="CHECK_SSP(nowSSP,application.caller_SSP,callee_SSP)==1">
							<log expr="'CHECK_SSP[1]'+nowSSP"/>
							<goto nextitem="release_end"/>
					<else/>
							<log expr="'CHECK_SSP[2]'+nowSSP"/>
							<goto nextitem="release_back"/>
					</if>		
				</filled>
		</object>
