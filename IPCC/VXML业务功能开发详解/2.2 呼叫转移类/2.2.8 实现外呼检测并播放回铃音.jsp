    ...
    <form id="main">
        ...
        <object name="MyCallSetup" classid="method://huawei/Call/CallSetup" expr="true">
            ...
            <filled>
                ...
                <else/>
                    <!--呼叫建立成功，需要播放等待音乐-->
                    <clear namelist="vpplaydrv stoppalaydrv MyMsgProc"/>
                </if>
            </filled>
        </object>   
        
        <!-- VP放音 -->
        <object name="vpplaydrv" classid="method://huawei/InOutPut/VPPlayDrv" expr="true">
			<!-- 文件服务器上的语音文件路径 -->
			<param name="PlaySentence" value="y:\wait.wav"/>
			<param name="PlayType" value="2"/>
			<param name="MaxDigit" value="0"/>
			<param name="PlayTimes" value="99"/>			
            ...
            <filled>
                ...
                <elseif cond="MyMsgProc=='USER_HOOK'"/>
                    <if cond="nCause == sspCallOut">
                        ...
                        <clear namelist="MyCheckRel"/>
                    <else/>
                        <assign name="stoppalaydrv" expr="true"/>
                        <log>主叫叫拆线</log>
                    </if>
                ...
                <elseif cond="MyMsgProc=='VP_END'"/> 
                     <clear namelist="MyMsgProc"/><!-- 放音结束或失败，则继续等待 -->
                     <assign name="stoppalaydrv" expr="true"/>
                <elseif cond="MyMsgProc=='VP_ERROR'"/>   
                     <clear namelist="MyMsgProc"/><!-- 放音结束或失败，则继续等待 -->  
                     <assign name="stoppalaydrv" expr="true"/>         
                <else/>
                    <!-- impossible -->
        ...
        <!-- 停止放音 -->
        <object name="stoppalaydrv" classid="method://huawei/InOutPut/StopPlayDrv" expr="true">
